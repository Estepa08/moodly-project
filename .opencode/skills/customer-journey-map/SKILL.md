...
**Consequence:** No insight into _why_ they feel that way or what to improve.
...
**Symptom:** Mapping what _you_ want customers to do, not what they _actually_ do
...
- NNGroup, _Customer Journey Mapping_ (2016) — Foundational framework
- Carnegie Mellon University, _Product Management Curriculum_ — Academic approach
- Chris Risdon & Patrick Quattlebaum, _Orchestrating Experiences_ (2018) — Journey mapping for service design
