...
export default function WellnessDisclaimer({ className }: Props) {
  const { t } = useTranslation();
  return (
    <div className={cn("flex items-start gap-2 rounded-xl bg-muted p-3 border border-border", className)}>
