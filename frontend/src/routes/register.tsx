        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <button type="button" className="text-primary hover:underline cursor-pointer transition-all duration-150 active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" onClick={() => navigate("/login")}>
                {t("register.signIn")}
              </button>
            </p>
          </form>
