...
export default function QuickEntryIcons({ createEntry, numericParams }: QuickEntryIconsProps) {
                  ...
                  <div className="flex justify-center gap-2">
                    {cfg.values.map((v) => (
                      <button
                        ...
                        className={`flex flex-col items-center gap-1 p-2.5 rounded-xl transition-all duration-150 cursor-pointer active:scale-[0.93] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
                    ...
                    {!showNote ? (
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="w-40 text-xs bg-muted rounded-lg px-2.5 py-1.5 border border-border focus:outline-none focus:ring-2 focus:ring-ring"
                          onKeyDown={(e) => {
                            if (e.key === "Enter") {
