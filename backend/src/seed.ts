...
async function seed() {
  ...
  await prisma.cbaCommonItem.createMany({
    data: [
      // category: anxiety
      { itemType: "advantage", itemText: "Избегаю неловкости/смущения прямо сейчас", category: "anxiety", itemKey: "anxiety.avoidEmbarrassment" },
      { itemType: "advantage", itemText: "Чувствую себя безопаснее", category: "anxiety", itemKey: "anxiety.safer" },
      { itemType: "advantage", itemText: "Не нужно сталкиваться с неопределённостью", category: "anxiety", itemKey: "anxiety.avoidUncertainty" },
      { itemType: "advantage", itemText: "Могу отложить решение проблемы", category: "anxiety", itemKey: "anxiety.postpone" },
      { itemType: "disadvantage", itemText: "Теряю время/возможности", category: "anxiety", itemKey: "anxiety.loseOpportunities" },
      { itemType: "disadvantage", itemText: "Тревога растёт от избегания", category: "anxiety", itemKey: "anxiety.growsAvoidance" },
      { itemType: "disadvantage", itemText: "Не проверяю, правда ли это на самом деле", category: "anxiety", itemKey: "anxiety.noRealityCheck" },
      { itemType: "disadvantage", itemText: "Чувствую себя хуже в долгосрочной перспективе", category: "anxiety", itemKey: "anxiety.worseLongTerm" },
      // category: self-esteem
      { itemType: "advantage", itemText: "Кажется, что самокритика мотивирует", category: "self-esteem", itemKey: "self-esteem.selfCritiqueMotivates" },
      { itemType: "advantage", itemText: "Не рискую ошибиться и услышать критику", category: "self-esteem", itemKey: "self-esteem.noRiskMistake" },
      { itemType: "disadvantage", itemText: "Снижаю уверенность в себе", category: "self-esteem", itemKey: "self-esteem.lowerConfidence" },
      { itemType: "disadvantage", itemText: "Чувство вины истощает, а не мотивирует", category: "self-esteem", itemKey: "self-esteem.guiltDrains" },
      { itemType: "disadvantage", itemText: "Не замечаю свои сильные стороны", category: "self-esteem", itemKey: "self-esteem.ignoreStrengths" },
      { itemType: "disadvantage", itemText: "Сравниваю себя с недостижимым идеалом", category: "self-esteem", itemKey: "self-esteem.unreachableIdeal" },
      // category: relationships
      { itemType: "advantage", itemText: "Избегаю конфликта прямо сейчас", category: "relationships", itemKey: "relationships.avoidConflict" },
      { itemType: "advantage", itemText: "Сохраняю видимость спокойствия", category: "relationships", itemKey: "relationships.appearCalm" },
      { itemType: "disadvantage", itemText: "Проблема не решается и накапливается", category: "relationships", itemKey: "relationships.problemGrows" },
      { itemType: "disadvantage", itemText: "Мешает отношениям с близкими", category: "relationships", itemKey: "relationships.hurtsClose" },
      { itemType: "disadvantage", itemText: "Напряжение всё равно чувствуется, просто скрыто", category: "relationships", itemKey: "relationships.hiddenTension" },
      { itemType: "disadvantage", itemText: "Другие решают за меня, не так, как нужно", category: "relationships", itemKey: "relationships.othersDecide" },
      // category: work
      { itemType: "advantage", itemText: "Заставляю себя выложиться на полную", category: "work", itemKey: "work.goAllIn" },
      { itemType: "advantage", itemText: "Лучше быть готовым, чем расслабленным", category: "work", itemKey: "work.bePrepared" },
      { itemType: "disadvantage", itemText: "Трачу силы на тревогу вместо работы", category: "work", itemKey: "work.energyOnWorry" },
      { itemType: "disadvantage", itemText: "Не даю себе шанс подготовиться", category: "work", itemKey: "work.noChancePrepare" },
      { itemType: "disadvantage", itemText: "Одна ошибка не делает дело провалом", category: "work", itemKey: "work.oneMistake" },
      { itemType: "disadvantage", itemText: "Не даёт двигаться к цели", category: "work", itemKey: "work.stopsProgress" },
      // category: health
      { itemType: "advantage", itemText: "Мгновенное облегчение от беспокойства", category: "health", itemKey: "health.instantRelief" },
      { itemType: "disadvantage", itemText: "Постоянное сканирование тела усиливает тревогу", category: "health", itemKey: "health.bodyScanning" },
      { itemType: "disadvantage", itemText: "Пропускаю реальный визит к врачу", category: "health", itemKey: "health.skipDoctor" },
      { itemType: "disadvantage", itemText: "Катастрофизирую обычные ощущения", category: "health", itemKey: "health.catastrophize" },
      { itemType: "disadvantage", itemText: "Убеждение мешает вести обычный образ жизни", category: "health", itemKey: "health.blocksNormalLife" },
      // category: habit
      { itemType: "advantage", itemText: "Не нужно ничего менять прямо сейчас", category: "habit", itemKey: "habit.noChange" },
      { itemType: "advantage", itemText: "Привычное поведение кажется безопасным", category: "habit", itemKey: "habit.comfort" },
      { itemType: "disadvantage", itemText: "Формирую привычку сдаваться при первой тревоге", category: "habit", itemKey: "habit.giveUpHabit" },
      { itemType: "disadvantage", itemText: "Упускаю время, которое могло пойти на улучшение", category: "habit", itemKey: "habit.lostTime" },
      { itemType: "disadvantage", itemText: "Тяжелее менять поведение, чем раньше", category: "habit", itemKey: "habit.harderLater" },
    ],
  });
