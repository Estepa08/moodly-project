...
import responsibilityPieRoutes from './routes/responsibility-pie.js';
import decatastrophizingRoutes from './routes/decatastrophizing.js';
...
await fastify.register(responsibilityPieRoutes);
await fastify.register(decatastrophizingRoutes);
